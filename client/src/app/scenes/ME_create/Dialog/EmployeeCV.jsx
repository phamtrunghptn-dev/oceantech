  ...
  return (
    <Grid container spacing={2}>
      <Grid container style={{ height: "20px" }}>
        ...
        <Grid item sm={2} xs={2} className="backgroundColor1"></Grid>
      </Grid>
      ...
      <Grid container style={{ margin: "0 0 10px 40px" }}>
        <Grid item container sm={6} xs={6}>
          ...
          <Grid item container sm={12} xs={12}>
            ...
            <Grid item sm={9} xs={9}>
              <span className="font-15">
                Ngày sinh: {moment(employee.birthDay).format("DD-MM-YYYY")}
              </span>
            </Grid>
          </Grid>
          <Grid item container sm={12} xs={12}>
            ...
            <Grid item sm={9} xs={9}>
              <span className="font-15">Số điện thoại: {employee.phone}</span>
            </Grid>
          </Grid>
          <Grid item container sm={12} xs={12}>
            <Grid item sm={1} xs={1}>
          ...
          <Grid item container sm={12} xs={12}>
            ...
            <Grid item sm={9} xs={9}>
              <span className="font-15">Email: {employee.email}</span>
            </Grid>
          </Grid>
        </Grid>
          ...
          <TextField
            ...
            onChange={(event) =>
              setEmployee((employee) => ({
                ...
                employeeCV: {
                  ...employee?.employeeCV,
                  careerGoals: event.target.value,
                },
              }))
            }
            variant="standard"
      ...
      <Grid container style={{ margin: "10px 0 10px 40px" }}>
              ...
              onChange={(event) =>
                setEmployee((employee) => ({
                  ...
                  employeeCV: {
                    ...employee?.employeeCV,
                    experience: {
                      ...employee?.employeeCV?.experience,
        ...
        <Grid container item sm={8} xs={8}>
          <span className="font-15">Mô tả công việc</span>
        </Grid>
        <Grid container item sm={8} xs={8} justifyContent="center">
          <TextField
        ...
        <Grid item sm={8} xs={8}>
          <TextField
            ...
            className="dotted title-1 color-1 font-15"
            placeholder="Dự án"
            fullWidth
            onChange={(event) =>
              setEmployee((employee) => ({
                ...
                employeeCV: {
                  ...
                  experience: {
                    ...employee?.employeeCV?.experience,
                    project: {
                      ...employee?.employeeCV?.experience?.project,
                      name: event.target.value,
                    },
                  },
                },
        ...
        <Grid item sm={8} xs={8}>
          <TextField
            ...
            className="dotted"
            placeholder="Mô tả công việc làm trong dự án"
            multiline
            fullWidth
            onChange={(event) =>
              setEmployee((employee) => ({
